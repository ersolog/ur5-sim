...
def is_qpos_feasible(
    ...
    ee_body_id = mujoco.mj_name2id(env.model, mujoco.mjtObj.mjOBJ_BODY, 'ur_wrist_3_link')
    ee_position = env.data.xpos[ee_body_id].copy()
    # print(f"ee pos: {ee_position}\n")
    if_feasible = True
    ...
    return if_feasible, ee_position
